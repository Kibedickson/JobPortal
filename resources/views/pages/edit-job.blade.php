                    ...
                    <div class="post-job box">
                        ...
                        <form class="form-ad" action="/manage-jobs/{{ $job->id }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="title" class="form-control" placeholder="Write job title" value="{{ $job->title }}">
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="location" id="location" class="form-control" placeholder="e.g.Ruiru, Kimbo" value="{{ $job->location }}">
                                @error('location')
                                <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="deadline" id="deadline" data-provide="datepicker" data-date-end-date="0d" class="form-control" placeholder="yyyy-mm-dd" value="{{ $job->deadline }}">
                                @error('deadline')
                                <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
                            <button type="submit" class="btn btn-common">Edit Job</button>
                        </form>
                    </div>
                </div>
            </div>
